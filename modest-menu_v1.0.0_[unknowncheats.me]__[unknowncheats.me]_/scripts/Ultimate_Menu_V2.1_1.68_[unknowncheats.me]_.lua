...
-- Credits
Credits:add_action("Goose#0484 | Developer", function()
	sleep(1)
end)
Credits:add_action("Kíllà'B#2348 | Debug Help", function()
	sleep(1)
end)
Credits:add_action("Bababoiiiii#7176 | Debug Help", function()
	sleep(1)
end)
